gsap.registerPlugin(ScrollTrigger);
    ...
    // let movingBGStart = $(".contents1").offset().top + $(".contents1").height()
    let movingBGStart = 0
    console.log(movingBGStart)
    ...
    scene1.to("#info", {
        ...
        scrollTrigger: {
            ...
            scrub: 4,
            onEnter: function() { gsap.to("#info", { scaleX: 1, rotation: 0 }) },
            onLeave: function() { gsap.to("#info", { scaleX: 1, rotation: 0 }) },
        }
    }, 0)
    ...
    clouds.to("#cloud3", { x: -1000 , y: 100}, 0)
    clouds.to("#cloud4", { x: -700, y: 100 }, 0)
    ...
    sun.to("#bg_grad stop:nth-child(2)", { attr: { offset: "0.03" } }, 0.00)
    sun.to("#bg_grad stop:nth-child(3)", { attr: { offset: "0.05" } }, 0.00)
    sun.to("#bg_grad stop:nth-child(4)", { attr: { offset: "0.15" } }, 0.00)
    sun.to("#bg_grad stop:nth-child(5)", { attr: { offset: "0.2" } }, 0.00)
    sun.to("#bg_grad stop:nth-child(6)", { attr: { "stop-color": "#FFD87D" } }, 0)
    ...
    sun2.to("#bg_grad stop:nth-child(2)", { attr: { offset: "0.5" } }, 0)
    sun2.to("#sun", { attr: { "stop-color": "#FFD87D" } }, 0)
    ...
    // Scroll Back text
    // scene3.fromTo("#arrow2", { opacity: 0 }, { opacity: 1, x: 210 , y : -300 }, 0.25)
